            ...
            <div class="mb-8">
                <div class="flex items-center text-sm text-gray-500 mb-2 breadcrumb-link">
                    ...
                    <a href="{{ route('puzzles.show', $puzzle->slug) }}"
                        class="hover:text-indigo-600">{{ $puzzle->title }}</a>
                    <svg class="w-4 h-4 mx-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
                            clip-rule="evenodd"></path>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">
                            Grade: <span
                                class="font-bold text-{{ $attempt->grade['color'] }}-600">{{ $attempt->grade['grade'] }}</span>
                            •
                                    ...
                                    <div class="p-4 {{ $feedback['is_correct'] ? 'bg-green-50' : 'bg-red-50' }}">
                                        <div class="flex items-start">
                                            <div class="flex-shrink-0 mr-3">
                                                ...
                                                @else
                                                    <svg class="h-5 w-5 text-red-600" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                            ...
                                            <div class="flex-1">
                                                @php
                                                    $isImage = filter_var($feedback['question'], FILTER_VALIDATE_URL);
                                                @endphp


                                                <p class="font-medium text-gray-900 mb-2">
                                                    Question {{ $index + 1 }}: {{!$isImage ? $feedback['question']: ''}}
                                                </p>
                                                @if ($isImage)
                                                    <div class="flag-container">
                                                        <img src="{{ $feedback['question'] }}" alt="Flag"
                                                            class="flag-image" loading="lazy">
                                                    </div>
                                                @endif
                                                <div class="grid grid-cols-2 gap-4 text-sm mb-2">
                                                    <div>
                                                        ...
                                                        <p
                                                            class="{{ $feedback['is_correct'] ? 'text-green-600' : 'text-red-600' }}">
                                            ...
                                            <div class="ml-4 text-right">
                                                <span
                                                    class="text-sm font-medium {{ $feedback['is_correct'] ? 'text-green-600' : 'text-red-600' }}">
